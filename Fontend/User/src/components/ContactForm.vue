<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="password" v-model="contactLocal.password">
        ...
        <div class="form-group d-grid gap-2 col-8 mx-auto">
            <button @click="isShow=!isShow"  class="btn btn-primary singin">Đăng kí</button>
        </div>
